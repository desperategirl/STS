...
public class ToDoListSQL {
	...
	public final static String complete_sql = "UPDATE" 
	...
	public String alarm_sql() {
		...
		sql.SET("td_alarm = DECODE(td_complete, 'Y', 'N', 'Y') ");
	...
	public String update_sql() {
		...
		return new SQL() {{
			...
			SET("td_date 	 = #{td_dat,jdbcType=VARCHAR}");
